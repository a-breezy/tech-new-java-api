...
public class User implements Serializable {
    @Id // id as unique identifier
    @GeneratedValue(strategy = GenerationType.AUTO) // the id is a auto-generated value
    private Integer id;
    private String username;
    @Column(unique = true) // email is unique
    private String email;
    private String password;
    @Transient // loggin isn't persistent
    boolean loggedIn;

    // FetchType.EAGER because we need the posts immediately
